<?php
	...
	$lastpagenum = ceil($numberofrecords / $limitPerPage);
	 ...
	 if ($pagenum != 1)  
	 {
		 $pagination .= "<a href='#?pagenum=1'> <<-First</a>";
		 $previous = $pagenum-1;
		 $pagination .= "<a href='#?pagenum=$previous'><-Previous</a> "; 
	 } 
	 ...
	 {
		 $next = $pagenum+1;
		 $pagination .=  "<a href='#?pagenum=$next'>Next -></a> ";
		 $pagination .= "<a href='#?pagenum=$lastpagenum'>Last ->></a> ";
	 } 
	 $pagination .="</div>";
