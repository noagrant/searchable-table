<!-- note: 
one approach for pagination is to present the first page and create the tabs as a links inside forms. 
each tab form will have a hidden input of name and a value of the page number
you then echo this first page back to index using json
each tab that is clicked will then be checked for its $_POST['tab'] and a database query will be generated to show that page 
...
<head>
	...
	<title>Eylem changed my title!</title>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			// show records
			//$("#searchform").submit();  // show all records when doc loads
			$('#name').keyup(function(){
				$("#searchform").submit();
				return false;
			});
